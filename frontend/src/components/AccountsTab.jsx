      ...
      <div className="content-grid">
        <div className="content-stack">
          ...
          <div className="soft-card">
            ...
            <button className="btn-good mt-4" type="button" onClick={onSubmitPassword} disabled={!canSubmitPassword}>
              修改密码
            </button>
          </div>
          ...
          {isTop ? (
            <div className="soft-card">
              ...
              <button className="btn-primary mt-4" type="button" onClick={onCreateUser} disabled={!canCreateUser}>
                新增账号
              </button>
            </div>
          ) : null}
          ...
          {isTop ? (
            <div className="soft-card">
              ...
              <div className="guide-actions mt-4">
                ...
                <button className="btn-secondary danger" type="button" onClick={onDeleteUser} disabled={!canDeleteSelected}>
                  删除账号
                </button>
              </div>

              <p className="status-line mt-4">{deleteHint}</p>
            </div>
          ) : null}
        </div>
        ...
        <aside className="content-stack">
          <section className="guide-card">
            <h3>{isTop ? "系统账号列表" : "当前账号信息"}</h3>
            <div className="space-y-2">
              {visibleUsers.map((user) => (
                <div key={user.username} className="status-line compact">
