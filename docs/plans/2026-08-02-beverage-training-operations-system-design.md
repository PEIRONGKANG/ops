...
- 图片、视频、文件和凭证存入受控对象存储；数据库仅保存元数据、访问权限、版本和关联关系。
...
| DQ-02 | 对象存储服务、备份策略与媒体访问域名 | 技术负责人/学院信息化负责人 | 阶段 1 开始前 |
...
- DQ-02、DQ-05、DQ-06、DQ-07 仍保持开放状态，开发人员不得自行补充媒体供应商、岗位达标阈值、邀请策略或归档销毁制度。
